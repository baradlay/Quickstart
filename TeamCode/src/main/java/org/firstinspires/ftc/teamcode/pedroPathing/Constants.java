...
public class Constants {
    ...
    public static final String SERVO_NAME = "my_servo";

    public static Servo createMyServo(HardwareMap hardwareMap) {
        // We use the centralized string name here
        return hardwareMap.get(Servo.class, SERVO_NAME);
    }
}
